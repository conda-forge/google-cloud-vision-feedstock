...
validate_recipe_outputs "google-cloud-vision-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="google-cloud-vision-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi